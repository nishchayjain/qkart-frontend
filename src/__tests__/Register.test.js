...
describe("Register Page", () => {
  ...
  it("should send a POST request to server with correct arguments", async () => {
    ...
    // CRIO_SOLUTION_START_MODULE_REGISTER
    /* NOTE - This seems to cause error when body is passed as 
      {
    ...
    */
    ...
    // FIXME - Add check for only 2 arguments present
    // Passing "formData" entirely which also has confirmPassword can cause the alert message tests to fail as mock doesn't work
    // Ref: https://help.crio.do/a/tickets/9522
